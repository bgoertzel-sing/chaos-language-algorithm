...
- JS-divergence context clustering integrated into category proposal generation
  - New JSCategoryInducer clusters tokens by context distribution similarity (threshold parameter)
